...
**Compatibility: React Native 0.55**. Live demo of the [React Native examples][examples-url] rendering with React DOM.
...
* **Write once, render anywhere**: interoperates with existing React DOM
  components and is compatible with the majority of the React Native API. You
can develop new components for native and web without rewriting existing code.
...
There are examples [on the website][website-url] and in the [website's source
code](https://github.com/necolas/react-native-web/blob/master/packages/website).
All the [React Native examples][examples-url] are also available. Here is an
...
| Touchable                | Available           | And additional support for mouse and keyboard interactions |
...
| AppRegistry              | Available           | And additional support for SSR with `getApplication` |
| AppState                 | Available           |  |
...
| I18nManager              | Available           | And additional support for runtime switch to RTL |
